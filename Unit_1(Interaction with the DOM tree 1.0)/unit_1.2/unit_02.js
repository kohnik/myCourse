...
document.querySelector('.out-4').textContent = e1 + f1; // Так как переменная е1 у нас строка, происходит конкатинация, из-за этого получается '35'. Если поставить в начале плюс, то переменная е1 будет числом
...
function t18() {
	...
	out.innerHTML = parseFloat(a.value);
}
