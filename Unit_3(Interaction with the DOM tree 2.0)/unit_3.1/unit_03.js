...
function f6(){
	let inputNum = +document.querySelector('.i-6').value;
...
function f7(){
	let inputNum1 = +document.querySelector('.i-71').value;
	let inputNum2 = +document.querySelector('.i-72').value;
	let out = document.querySelector('.out-7');

	out.innerHTML = Math.pow(inputNum1, inputNum2);
}
...
function f9(){
		let inputNum = +document.querySelector('.i-9').value;
...
function f13(){
		...
		out.innerHTML = (typeof inputIn); // String из-за того, что, JS без разницы какой будет value у инпута, он всё переводит в строку.
}
...
function f15(){
		let selectNum1 = +document.querySelector('.s-151').value;
		let selectNum2 = +document.querySelector('.s-152').value;
		let selectOperation = document.querySelector('.s-153').value;
		let out = document.querySelector('.out-15');

		switch (selectOperation) {
			case '&&':
					out.innerHTML = selectNum1 && selectNum2;
					break;
			case '||':
					out.innerHTML = selectNum1 || selectNum2;
					break;
