...
function f7() {
		let inputIn = document.querySelector('.i-7').value;
		let outPwd = document.querySelector('.out-71');
		let outLength = document.querySelector('.out-72');

		outPwd.innerHTML = inputIn;

		if (inputIn.length >= 6) {
				outLength.innerHTML = 1;
		} else {
				outLength.innerHTML = 0;
		}
...
function f9() {
		...
		if (radioBtn.checked === true) {
				...
				out.innerHTML = radioBtn.checked;
		}
...
function f10() {
		...
		out.style.background = inputColor;
...
function f14() {
		let inputTextArea = document.querySelector('.t-14').value;
		let out = document.querySelector('.out-14');

		out.innerHTML = inputTextArea;
...
function f15() {
		let inputText = document.querySelector('.i-15').value;
...
function f16() {
    // для получения выбранного option просто получите select в переменную и select.value;
		let selectNum = document.querySelector('.s-16').value;
		let out = document.querySelector('.out-16');

		out.innerHTML = selectNum;
...
function f17() {
		let selectNum = document.querySelector('.s-17').value;
...
function f18() {
		let selectNum = document.querySelector('.s-18').value;
		let inputIn = document.querySelector('.i-18');

		inputIn.value = selectNum;
}
