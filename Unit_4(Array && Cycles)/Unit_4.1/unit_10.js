...
let ar1 = ['Hello', 'World', 123, true, false, 'yes', 'no', 115]
...
let ar2 = ['Hello', 'World', 123, true, false, 'yes', 'no', 115]
...
let ar3 =  ['Hello', 'World', 123, true, false, 'yes', 'no', 115]
...
function f8() {
		...
		ar8[4] = 17;
		ar8[6] = 5; 
		const outFirst = document.querySelector('.out-8');
		const outTwo = document.querySelector('.out-8-1');

		outFirst.innerHTML = `${ar8[3]} - ${ar8[4]} - ${ar8[6]}`;
...
function f9() {
		document.querySelector('.out-9').innerHTML = ar9.length-1;
}
...
function f18() {
		...
		for (let index = 0; index < ar18.length; index++) {
			if (max < ar18[index]) {
				max = ar18[index]
			}
		}
...
function f19() {
	...
	document.querySelector('.out-19').innerHTML = minItem;
}
