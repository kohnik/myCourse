...
//1) полчаем значение i8
//2) создаем пустой массив temp
//3) в первый индекс массива temp запишем значение i8
//4) в цикле переберем d8 массив
//5) в temp перепишем элементы массива d8 НО учтем что в temp[0] есть уже значение
//6) запишем в массив d8 массив temp
...
function f11() {
    ...
    out.innerHTML = d11.indexOf(parseInt(input, 10), 0);
...
//arr[arr.length] // получаем ЗНАЧЕНИЕ массива по ИНДЕКСУ (arr.length)
//arr.length - 1 //длина массива 
//arr.length // следующий элемент массива, его сейчас нет, он undef(делали в методе push)