...
function t2() {
		...
		fetch(`http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=2&name=Pavel`)
				.then(data => {
						return data.text();
				})
				.then(data => {
...
function t3() {
		...
		fetch(`${link}&action=3&num1=4&num2=4`)
				.then(data => {
						return data.text()
				})
				.then(data => {
...
function t4() {
		...
		fetch(`${link}&action=4&num1=1&num2=50`)
				.then(data => {
						return data.text()
				})
				.then(data => {
...
function t6() {
		...
		fetch(`${link}&action=6&num1=20&num2=40`)
				.then(data=> {
						return data.text()
				})
				.then(data => {
...
function t9() {
		...
		fetch(`${link}&action=9&m=1&d=1&y=1`)
				.then(data => {
						return data.text()
				})
				.then(data => {
...
function t12() {
		...
		fetch(`${link}&action=3&num1=44&num2=44`, {
				method:'POST',
				headers: {'Content-type': 'application/x-www-form-urlencoded'},
				body: `${auth}&action=3&num1=44&num2=44`
		})
				.then(response => {
						return response.text()
				})
...
function t15() {
		...
		fetch(`${link}&action=6&num1=1&num2=88`, {
				method:'POST',
				headers: {'Content-type': 'application/x-www-form-urlencoded'},
				body: `${auth}&action=6&num1=1&num2=88`
		})
				.then(response => {
						return response.text()
				})
...
function t18() {
		...
		fetch(`${link}&action=9&m=1&d=1`, {
				method:'POST',
				headers: {'Content-type': 'application/x-www-form-urlencoded'},
				body: `${auth}&action=9&m=1&d=41`
		})
				.then(response => {
						return response.text()
				})
